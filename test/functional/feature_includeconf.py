...
class IncludeConfTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("-includeconf works from config file. subversion should contain 'main; relative)/'")
        ...
        self.log.info("-includeconf cannot be used recursively. subversion should contain 'main; relative)/'")
        ...
        self.log.info("multiple -includeconf args can be used from the base config file. subversion should contain 'main; relative; relative2)/'")
        with open(self.nodes[0].datadir_path / "relative.conf", "w") as f:
