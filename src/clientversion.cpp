...
/**
 * $DOG Mode's name and version, reported in the 'version' message as a second
 * BIP 14 component after the Bitcoin Core one above, the way Bitcoin Knots
 * reports itself: "/Satoshi:31.1.0/DOGMode:20260902/". The Bitcoin Core
 * component stays first and unchanged. The version is a date (YYYYMMDD), as
 * BIP 14 recommends; set it to the release date when a release is tagged.
 */
const std::string UA_DOGMODE("DOGMode:20260902");
